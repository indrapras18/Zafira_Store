        ...
        <div class="card-body">
            <div class="row align-items-end">
                <div class="col-md-6 position-relative">
                    ...
                    <input type="text" class="form-control" id="search" placeholder="Masukkan nama atau kode barang..." autocomplete="off">
        ...
        fetch(`/sales/barangs?q=${keyword}`)
            ...
            .then(data => {
                ...
                data.forEach(item => {
                    ...
                    li.innerText = `${item.nama_barang} (${item.kode_barang}) - ${formatRupiah(item.harga)}`;
                    li.onclick = () => {

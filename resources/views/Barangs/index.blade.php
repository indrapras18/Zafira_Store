...
<div class="container">
    ...
    <div class="page-header">
        <h1 class="page-title">
            <i class="bi bi-box-seam me-3"></i>Data Barang
        </h1>
    ...
    <div class="row mb-4">
        <div class="col-md-3 col-sm-6 mb-3">
            <div class="stats-card">
                <div class="stats-number">{{ $barangs->count() }}</div>
        ...
        <div class="col-md-3 col-sm-6 mb-3">
            <div class="stats-card" style="background: var(--success-gradient);">
                <div class="stats-number">{{ $barangs->sum('stok') }}</div>
                <div class="stats-label">
        ...
        <div class="col-md-3 col-sm-6 mb-3">
            <div class="stats-card" style="background: var(--secondary-gradient);">
                <div class="stats-number">{{ $barangs->where('stok', '<', 10)->count() }}</div>
                <div class="stats-label">
        ...
        <div class="col-md-3 col-sm-6 mb-3">
            <div class="stats-card" style="background: linear-gradient(135deg, #ff9a9e 0%, #fecfef 100%);">
                <div class="stats-number">Rp {{ number_format($barangs->sum('harga'), 0, ',', '.') }}</div>
                <div class="stats-label">
                            ...
                            <tr class="fade-in-up" style="animation-delay: {{ $index * 0.1 }}s">
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-sm me-3" style="width: 40px; height: 40px; background: var(--primary-gradient); border-radius: 10px; display: flex; align-items: center; justify-content: center;">
